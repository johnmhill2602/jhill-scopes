# ograph ztmps for entire 6.5m casting LOTIS, April 2002

ograph noven=0 ncomp=0 dateleft=020329 dateright=INDEF \\
timelori="" timerori="now" timeloff=1400 timeroff=20 \\
...
info2="" info3="" info4="" \\
subsample=20 append=yes timeunit="days"
