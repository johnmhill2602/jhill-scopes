...
# Added third flash for camera E; 22JUL05
...
begin
  ...
  if ( verb > 2 ) {
	...
	print ("  version of 28MAR08,   vindex = ", vindex)
  } # end if

  if ( strlen(vlogfile) > 0 ) {
	print ("Starting new copy of videoc.cl", >> vlogfile )
	print ("  version of 28MAR08,   vindex = ", vindex, >> vlogfile )
  } # end if
...
# second pass of flash images
    ...
    ovenw
    takepic ( vroot, camera="e", flash="abc", exposure=vfexp,
	index=vindex, pname=vpath, xname=vtemp, xhost=vhost, auto=vauto,
	logfile=lastfile, clobber=yes, verb=verb )
