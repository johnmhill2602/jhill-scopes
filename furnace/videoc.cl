...
# Updated for GMT1 casting - no camera B, 20JUL05
# Added third flash abc for camera E; 22JUL05
# Commented out deceased cameras A, C; 23JUL05
# Activate cameras A,C for LSST; 25MAR08
# Change flashes for camera A to A,D; 28MAR08
# Removed third flash ac for camera E; 24AUG09
...
begin
  ...
  if ( verb > 2 ) {
	...
	print ("  version of 24AUG09,   vindex = ", vindex)
  } # end if

  if ( strlen(vlogfile) > 0 ) {
	print ("Starting new copy of videoc.cl", >> vlogfile )
	print ("  version of 24AUG09,   vindex = ", vindex, >> vlogfile )
  } # end if
...
# first pass with infrared frames
    ovenw
	...
	# This part has the comments describing the export process
	if (export) {
