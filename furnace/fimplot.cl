procedure fimplot (fname)

# cl script to convert a FITS image to IRAF format and implot it.
...
begin
	...
	while ( fscan(list1, gname) != EOF) {	
	    ...
	    # implot the image using the preset implot parameters
	    implot (jname)
