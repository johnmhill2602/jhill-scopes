...
$redcname = "ifrdb_2.gif";
$reddname = "videod_2.gif";
$redename = "ifrdd_2.gif";
...
print "<center><H1>2MD2 NGST Prototype Mirror</H1></center>\n";

print "<center><h1>Latest Views Inside the Furnace</h1></center>\n";
...
print "<a href=\"video2.cgi?$picbname&$ARGV[0]\">Camera B<br>\n";
print "<img src=\"$imgbname\" width=282 height=243></a>\n";
print freshness($picbname);
print "</td>\n";

print "<td align=middle width=\"20%\">\n";
print "<a href=\"video2.cgi?$picdname&$ARGV[0]\">Camera D<br>\n";
...
print "<td align=middle width=\"20%\">\n";
print "<a href=\"video2.cgi?$piccname&$ARGV[0]\">Infrared B<br>\n";
print "<img src=\"$imgcname\" width=282 height=243></a>\n";
print freshness($piccname);
print "</td>\n";

print "<td align=middle width=\"20%\">\n";
print "<a href=\"video2.cgi?$picename&$ARGV[0]\">Infrared D<br>\n";
