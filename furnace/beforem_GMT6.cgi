...
print "<center><font size=4><b>Richard F. Caris Mirror Lab: GMT6 Ninth 8.4m Mirror</b></center></font>\n";
...
print "<th>Before Melting View @ 456 C</th>\n";
print "<th>Middle of Melting @ 882 C</th>\n";
...
print "<a href=\"video_GMT6.cgi?early1.png\">Camera 1a (wide)<br>\n";
print "<img src=\"early1_red.png\" width=436 height=326></a><br>\n";
print freshness("early1.png");
print "</td>\n";

print "<td align=middle valign=top width=\"20%\">\n";
print "<a href=\"video_GMT6.cgi?middle1.png\">Camera 1a (wide)<br>\n";
print "<img src=\"middle1_red.png\" width=436 height=326></a><br>\n";
...
print "<td align=middle valign=top width=\"20%\">\n";
print "<a href=\"video_GMT6.cgi?early3.png\">Camera 3c (wide)<br>\n";
print "<img src=\"early3_red.png\" width=436 height=326></a><br>\n";
print freshness("early3.png");
print "</td>\n";

print "<td align=middle valign=top width=\"20%\">\n";
print "<a href=\"video_GMT6.cgi?middle3.png\">Camera 3c (wide)<br>\n";
print "<img src=\"middle3_red.png\" width=436 height=326></a><br>\n";
...
print "<td align=middle valign=top width=\"20%\">\n";
print "<a href=\"video_GMT6.cgi?early4.png\">Camera 4d (wide)<br>\n";
print "<img src=\"early4_red.png\" width=436 height=326></a><br>\n";
print freshness("early4.png");
print "</td>\n";

print "<td align=middle valign=top width=\"20%\">\n";
print "<a href=\"video_GMT6.cgi?middle4.png\">Camera 4d (wide)<br>\n";
print "<img src=\"middle4_red.png\" width=436 height=326></a><br>\n";
...
print "<td align=middle valign=top width=\"20%\">\n";
print "<a href=\"video_GMT6.cgi?early5.png\">Camera 5e (edge)<br>\n";
print "<img src=\"early5_red.png\" width=436 height=326></a><br>\n";
print freshness("early5.png");
print "</td>\n";

print "<td align=middle valign=top width=\"20%\">\n";
print "<a href=\"video_GMT6.cgi?middle5.png\">Camera 5e (edge)<br>\n";
print "<img src=\"middle5_red.png\" width=436 height=326></a><br>\n";
...
print "<td align=middle valign=top width=\"20%\">\n";
print "<a href=\"video_GMT6.cgi?early6.png\">Camera 6f (edge)<br>\n";
print "<img src=\"early6_red.png\" width=436 height=326></a><br>\n";
print freshness("early6.png");
print "</td>\n";

print "<td align=middle valign=top width=\"20%\">\n";
print "<a href=\"video_GMT6.cgi?middle6.png\">Camera 6f (edge)<br>\n";
print "<img src=\"middle6_red.png\" width=436 height=326></a><br>\n";
...
print "<td align=middle valign=top width=\"20%\">\n";
print "<a href=\"video_GMT6.cgi?early7.png\">Camera 7g (edge)<br>\n";
print "<img src=\"early7_red.png\" width=436 height=326></a><br>\n";
print freshness("early7.png");
print "</td>\n";

print "<td align=middle valign=top width=\"20%\">\n";
print "<a href=\"video_GMT6.cgi?middle7.png\">Camera 7g (edge)<br>\n";
print "<img src=\"middle7_red.png\" width=436 height=326></a><br>\n";
print freshness("middle7.png");
print "</td>\n";

print "<td align=middle valign=top width=\"20%\">\n";
print "<a href=\"video_GMT6.cgi?$picgname&$refreshtime\">Camera 7g (edge)<br>\n";
print "<img src=\"$picgname\" width=436 height=326></a><br>\n";
...
#print "<td align=middle valign=top width=\"20%\">\n";
#print "<a href=\"video_GMT6.cgi?early2.png\">Camera B (center)<br>\n";
#print "<img src=\"early2_red.png\" width=436 height=326></a>\n";
#print freshness("early2.png");
#print "</td>\n";

#print "<td align=middle valign=top width=\"20%\">\n";
#print "<a href=\"video_GMT6.cgi?middle2.png\">Camera B (center)<br>\n";
...
print "\nThis page was generated automatically by J. M. Hill's \"beforem.cgi\" script, version $version.<br>\n";
