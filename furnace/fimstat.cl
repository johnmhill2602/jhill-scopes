procedure fimstat (fname)

# cl script to convert a FITS image to IRAF format and imstat it.
# Created 25JAN94 by J. M. Hill, Steward Observatory
# Version 01FEB94 -- Added filename templates, dirpath stripping.
...
string	isect=""		{prompt="image section for statistics"}
...
begin
	# define variables
	file rname, sname, jname, gname, temp1
	...
	while ( fscan(list1, gname) != EOF) {	
		...
		# imstat the image using the preset imstat parameters
		imstat (sname)
