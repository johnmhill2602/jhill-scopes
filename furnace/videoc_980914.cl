...
# Also export infrared GIF images, 14SEP98
...
begin
  ...
  if ( verb > 2 ) {
	...
	print ("  version of 14SEP98,   vindex = ", vindex)
  } # end if

  if ( strlen(vlogfile) > 0 ) {
	print ("Starting new copy of videoc.cl", >> vlogfile )
	print ("  version of 14SEP98,   vindex = ", vindex, >> vlogfile )
  } # end if
