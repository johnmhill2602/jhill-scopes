procedure fdisplay (fname,frame)

# cl script to convert a FITS image to IRAF format and display it.
# Created 25JAN94 by J. M. Hill, Steward Observatory
# Version 02FEB94 -- Added filename templates, dirpath stripping.
...
begin
	...
	while ( fscan(list1, gname) != EOF) {	
	    ...
	    # display the image on saoimage/ximtool
	    #    using the preset display parameters
	    display (jname, frame)
