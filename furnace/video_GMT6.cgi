...
print "<tr>\n";
print "<td bgcolor=\"#aaaaaa\" align=middle width=\"20%\">\n";
...
print "Image from ", freshness($picture), "&nbsp; $picture<br>\n";
	...
	print "The oven temperature was <b>", $tlid, "</b> degrees C at ", freshness($tempname), "\n<br>\n";
    }
