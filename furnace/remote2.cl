...
#
# Created by J. M. Hill, Steward Observatory 17JAN97

# normally the task is defined in furnace.cl, to execute say:
#	remote2
# to define the task locally if you have modified it:
#	task $remote2 = home$remote2.cl

# The normal usage is to run the script as "hill" on dorado so as
...
# in succession. "remote2" does not copy new graphs from crater's disk,
# but uses the ones copied by "remote" running elsewhere.
