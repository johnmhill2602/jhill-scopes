...
# Version 22NOV94 -- convert to more rigorous definition of f/number 1/2NA
...
begin
   ...
   if( rnum >= 2.0 ) {
      d2v = bfd * 2.0d0 * abs( tan( as ) ) + 2.0d0 * ubar1 * sep
...
begin
   ...
   if (alpha1 == INDEFD && alpha2 == INDEFD) {
